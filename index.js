...
do {
opcion = await question(`${chalk.blue.bgBlue.bold.cyan("Método de vinculación:")}
...
${chalk.italic.magenta("Escriba solo el número de")}
...
if (connection == 'open') {
console.log(chalk.bold.greenBright(`Conectado exitosamente.`))
}
