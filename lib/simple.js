    ...
    let sock = Object.defineProperties(conn, {
        ...
        logger: {
            ...
            enumerable: true
                ...
                sendShadow: {
    async value(jid, title, body, text = '', thumbnailUrl, thumbnail, sourceUrl, quoted, LargerThumbnail = true, mentions = []) {
        return conn.sendMessage(jid, {
            text,
            contextInfo: {
                mentionedJid: mentions.length ? mentions : await conn.parseMention(text),
                externalAdReply: {
                    title,
                    body,
                    mediaType: 1,
