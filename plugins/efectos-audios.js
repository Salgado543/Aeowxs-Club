...
let handler = async (m, { conn, args, __dirname, usedPrefix, command }) => {
    try {
        ...
        } else return conn.reply(m.chat, `*${emojis} Responda al audio o nota de voz*`,m)
    } catch {
        await m.react('✖️')
    }
}
handler.help = ['bass', 'blown', 'deep', 'earrape', 'fast', 'fat', 'nightcore', 'reverse', 'robot', 'slow', 'smooth', 'tupai', 'reverb', 'chorus', 'flanger', 'distortion', 'pitch', 'highpass', 'lowpass', 'underwater']
